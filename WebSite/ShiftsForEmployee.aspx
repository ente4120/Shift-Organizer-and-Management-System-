<%@ Page Title="" Language="C#" MasterPageFile="~/MayaUserMasterPage.master" AutoEventWireup="true" CodeFile="ShiftsForEmployee.aspx.cs" Inherits="sample" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
        <div class="col-lg-10">
            <a class="btn btn-lg" href="ShiftForEmployee.aspx" style="height:40px; width:160px; margin-bottom:5px;background-color:#ADFF2F; color:black;">הגשת משמרת <img src="img/add_shift.png" style="height:25px;"/></a>
      ...
      <div class="modal-body">
          <h5>משמרות שלי</h5>
            <table>                       
                ...
                <asp:DropDownList ID="DropDownList01" runat="server" CssClass="custom-select" style="width: 250px; margin: 0; display: inline-block;"></asp:DropDownList>
                    </td>
                    <td>
