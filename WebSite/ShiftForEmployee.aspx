<%@ Page Title="" Language="C#" MasterPageFile="~/MayaUserMasterPage.master" AutoEventWireup="true" CodeFile="ShiftForEmployee.aspx.cs" Inherits="ShiftForEmployee" %>
    ...
    window.onload = function ShiftSettings(src, arg) {
        ...
        for (var i = 1; i < 8; i++) {
            for (var y = 1; y < 4; y++) {
                ...
                if (check < 0)
                    document.getElementById(temp2).className ="btn btn-outline-light disabled";
            }
        }
    }
...
<%--    <input type="text" class="form-control" id="empNum" placeholder="הזן מספר עובד להודעה" style="width: 50%; margin: 0; display: inline-block;" runat="server">--%>
...
<table class="table text-center" style="background-color: rgba(255, 255, 255, 0.86);">
  ...
  <tr>
    ...
    <a ID="Button2" class="btn btn-lg" href="ShiftsForEmployee.aspx"  runat="server" style="height:40px;background-color:#ADFF2F; color:black;">חזרה</a>
